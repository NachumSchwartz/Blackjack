...
public class GameFrame extends JFrame{
	...
	public GameFrame(boolean test){//test is true if game is in test mode
		...
		layeredPane = new JLayeredPane(); // Create a layered pane
		setContentPane(layeredPane); // Set the content pane of the frame to the layered pane

		// Add background label to the layered pane
		backgroundLabel = new JLabel(new ImageIcon("images/background.png")); // Create a label with a background image
		...
		gamePanel = new GamePanel(test); //Create a new game panel
